...
#--- 海底地形描画版
mecascale=3.4      # To change the size of the mechanism solution, change the value of mecascale.
#---
...
gmt begin ffi_MapMecaSnap png
  ...
  gmt subplot begin ${row}x${column} -Fs${mapwidth} -M0.10/0.3 -SCb -SRl -Bxa0.5 -Bya0.5 -BWSne -R${r} -JM${mapwidth}
    ...
    #   gmt grdimage tmp.grd -Cslip.cpt  -t35.
    #   gmt grdcontour tmp.grd -Cslip.cpt${interval}
      gmt coast -Df -W0.25 -Glightgray
