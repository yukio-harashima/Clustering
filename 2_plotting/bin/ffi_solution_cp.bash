...
#------ infomation
  ...
  echo 0 2  ak135-F | gmt text -F+f10p,0,black+jLB  -N -R0/10/0/4  -JX10/1.8  -Y25
...
#------ Moment tensor solution
  awk '{if (NR==1) print 0.5,0.5,1,$0,20}' tpdt.dat | gmt meca -R0/1/0/1 -JX4 -Sm4 -M -T0 -G195/51/44 -Y-3.5 -N
...
#------ Moment rate function
  ...
  gmt basemap -JX5/4 -R${xmin}/${xmax}/${ymin}/${ymax} -Bx+l"Time (s)" -By+l"Moment rate (10@+18@+ Nm/s)" -BWS -Y-4.5
