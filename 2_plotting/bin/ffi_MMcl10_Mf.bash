...
#--- 海底地形描画版
# awkコマンドに直接指定
mecascale=5   # To change the size of the mechanism solution, change the value of mecascale.

# clno=3 # Cluster number, seems fixed
#---
...
#--- Begin GMT plotting
output_filename="ffi_MapMecaClusteringSnap10_${i1}"
if [ $# -eq 5 ]; then
